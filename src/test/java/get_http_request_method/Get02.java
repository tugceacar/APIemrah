...
public class Get02 extends HerOkuAppBaseUrl {
    ...
    //Note: Path Parameters are used to make resources smaller.

    /**
        NOTE: For base url I create a package and, in the package I create a base url class. I am using base url from there.
        AND In every test method I don't need type base url again and again.
     */
