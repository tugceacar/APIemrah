...
public class Post01 extends HerOkuAppBaseUrl {
    ...
    //Note: Actual Result from API and, Expected Result from Our Test Case.
    ...
    public void pots01(){
        ...
        //4.step: do assertion //Means: all keys should be String and  all value should be Object data type. right?
